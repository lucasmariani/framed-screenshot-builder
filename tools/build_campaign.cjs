...
const txt=(id,text,x,y,width,size)=>({id,type:'text',name:id,text,x,y,width,fontFamily:id==='title'?'Bodoni 72':'Baskerville',fontWeight:id==='title'?700:400,fontSize:id==='title'?size:83,lineHeight:id==='title'?1.03:1.14,letterSpacing:0,color:'#20251e',align:'left'});
